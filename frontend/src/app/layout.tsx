...
const links: { label: string; path: string; blank?: boolean }[] = [
  ...
  { label: 'GitHub', path: 'https://github.com/solana-developers/confidential_balances_microsite', blank: true },
  { label: 'Docs', path: 'https://www.solana-program.com/docs/confidential-balances', blank: true },
